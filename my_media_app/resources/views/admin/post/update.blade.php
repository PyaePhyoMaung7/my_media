        ...
        <div class="card-body">
            <form action="{{route('admin#updatePost',$post['post_id'])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="postTitle" value='{{old('postTitle',$post['title'])}}' placeholder="Enter Post Title">
                    @error('postTitle')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="postDescription"  rows="3" placeholder="Enter Post Description">{{old('postDescription',$post['description'])}}</textarea>
                ...
                <div class="form-group">
                    ...
                    @endif class="w-100 rounded shadow" alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="postCategory" id="" class="form-control">
                        ...
                        @foreach ($categories as $category)
                            <option value="{{$category->category_id}}" @if($post['category_id'] == $category->category_id) selected @endif>{{$category->title}}</option>
                        @endforeach
                    </select>
                    @error('postCategory')
                        <div class="text-danger">{{$message}}</div>
                ...
                <a href="{{route('admin#post')}}"><input type="button" value="Create" class="btn btn-dark"></a>
            </form>
        </div>
    </div>
                ...
                <tr >
                    ...
                    <td class="align-middle">
                        <img @if ($post['image'] !== null)
                            ...
                            @else
                                src="{{asset('default_image/default_image.jpg')}}"
                            @endif style="width:100px; height:70px" class="object-fit-cover rounded shadow" alt="">
                    </td>
                    <td class="align-middle">
